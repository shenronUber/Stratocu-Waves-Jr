...
%% 1) VARIABLES SETUP
%----------- DATE/TIME SETTINGS ---------------------------
startDate = datetime(2023, 10, 11, 1, 0, 0);     % Start of processing period
endDate   = datetime(2023, 10, 14, 9, 0, 0);    % End of processing period
    ...
    for iInst = 1:numel(instrumentList)
        ...
        if ~isfile(singleNcFile)
            ...
            produceAnnotatedImages(instr, spec_full, data_filt, squares, Scales, Angles, singleOutDir, ...
                frameDateStr, saverose, nAngles_fineFactor, ...
                nScales_fineFactor, peakDetectionFactor, ArrayMode, contourArray);
        else
